...
(function seedServicios(){
    if (!localStorage.getItem("servicios")) {
      const serviciosSeed = [        
        ...
        { id: 2, nombre: "Tienda Online", precio: 3000000, imagen: "assets/img/tienda_online.jpg", descripcion: "E-commerce completo", cantidad: 4, promo: true },
        { id: 3, nombre: "App Móvil", precio: 3600000, imagen: "assets/img/App_movil.jpg", descripcion: "App híbrida para Android y iOS", cantidad: 6, promo: true },
        ...
        { id: 5, nombre: "Integración API", precio: 1000000, imagen: "assets/img/API.jpg", descripcion: "Conecta sistemas externos", cantidad: 7, promo: true },
        { id: 6, nombre: "Análisis de Datos", precio: 1500000, imagen: "assets/img/analisis_datos.jpg", descripcion: "Dashboard y métricas clave", cantidad: 2, promo: true },
        ...
        { id: 10, nombre: "Soporte Prioritario", precio: 900000, imagen: "assets/img/soporte.jpg", descripcion: "Atención técnica preferente", cantidad: 15, promo: false }
      ];
